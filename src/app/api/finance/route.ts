...
const LABELS: Record<string, string> = {
  ...
  employmentStatus: "Employment Status", employerName: "Company Name", workAddress: "Work Address",
  timeEmployed: "Term at Work", employerContact: "Work Tel", jobTitle: "Occupation",
  grossIncome: "Gross Salary", netSalary: "Nett Salary", otherIncome: "Other Income",
  ...
  livingExpenses: "Other Living Expenses", totalExpenses: "Total Expenses",
  bankName: "Bank Name", accountNumber: "Account Number", timeWithBank: "Time With Bank",
  referenceName: "Reference Name", referencePhone: "Reference Cell",
  vehicleOfInterest: "Vehicle of Interest", depositAmount: "Deposit", monthlyBudget: "Monthly Budget",
  tradeIn: "Trade-In", dealNotes: "Deal / Trade-In Notes",
